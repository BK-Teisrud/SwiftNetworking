...
See the [handbook](Handbook.md) for defaults, examples, security boundaries, and lifecycle contracts. This reference includes every public declaration and any synthesized protocol members emitted by the active toolchain.
